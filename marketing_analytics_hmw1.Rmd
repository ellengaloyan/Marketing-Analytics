...
```{r}
library(knitr)
knitr::include_graphics("/Users/ellengaloyan/Desktop/harpercollins.pdf")
```
...
```{r}
library(knitr)
knitr::include_graphics("/Users/ellengaloyan/Desktop/listener_info.pdf")
```
...
```{r}
library(knitr)
knitr::include_graphics("/Users/ellengaloyan/Desktop/diffusion.pdf")
```
